...
<body>
	...
	<div class="container">
		...
		<!-- Side - Navbar -->
		<div class="side-nav">
			<a  class="side-nav-active" href="profile.php">Profile</a>
			<a href="chefDashboard.php">Bookings</a>
		</div>

		<!-- Content Section -->
		<div class="content">
			<div class="current-location">User / <a href="profile.php">My Profile</a></div>
